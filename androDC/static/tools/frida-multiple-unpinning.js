...
setTimeout(function () {
  Java.perform(function () {
    ...
    try {
      ...
      okhttp3_Activity_4.check$okhttp.overload(
        "java.lang.String",
    ...
    try {
      ...
      trustkit_PinningTrustManager.checkServerTrusted.overload(
    ...
    try {
      ...
      var TrustManagerImpl_Activity_1 = Java.use(
      ...
      TrustManagerImpl_Activity_1.checkTrustedRecursive.implementation =
        function (
          ...
          console.log(
            "[+] Bypassing TrustManagerImpl (Android > 7) checkTrustedRecursive check for: " +
              host
          );
      ...
      console.log(
        "[-] TrustManagerImpl (Android > 7) checkTrustedRecursive check not found"
      );
      //console.log(err);
      errDict[err] = [
        "com.android.org.conscrypt.TrustManagerImpl",
    ...
    try {
      ...
      var TrustManagerImpl_Activity_2 = Java.use(
        "com.android.org.conscrypt.TrustManagerImpl"
      );
      TrustManagerImpl_Activity_2.verifyChain.implementation = function (
        untrustedChain,
        trustAnchorChain,
        host,
        clientAuth,
        ...
        console.log(
          "[+] Bypassing TrustManagerImpl (Android > 7) verifyChain check for: " +
            host
        );
      ...
      console.log(
        "[-] TrustManagerImpl (Android > 7) verifyChain check not found"
      );
      //console.log(err);
      errDict[err] = [
        "com.android.org.conscrypt.TrustManagerImpl",
    ...
    ////////////////////////////////
    try {
      var fabric_PinningTrustManager = Java.use(
        "io.fabric.sdk.android.services.network.PinningTrustManager"
      );
      fabric_PinningTrustManager.checkServerTrusted.implementation = function (
        chain,
        authType
      ) {
    ...
    try {
      ...
      conscrypt_CertPinManager_Activity.checkChainPinning.overload(
        "java.lang.String",
        "java.util.List"
      ).implementation = function (a, b) {
    ...
    ///////////////////////////////////////
    try {
      var legacy_conscrypt_CertPinManager_Activity = Java.use(
        "com.android.org.conscrypt.CertPinManager"
      );
      legacy_conscrypt_CertPinManager_Activity.isChainValid.overload(
        "java.lang.String",
        "java.util.List"
      ).implementation = function (a, b) {
    ...
    try {
      ...
      var AndroidWebViewClient_Activity_3 = Java.use(
        "android.webkit.WebViewClient"
      );
      ...
      AndroidWebViewClient_Activity_3.onReceivedError.implementation =
        function (view, errCode, description, failingUrl) {
    ...
    try {
      ...
      var AndroidWebViewClient_Activity_4 = Java.use(
        "android.webkit.WebViewClient"
      );
      AndroidWebViewClient_Activity_4.onReceivedError.overload(
        "android.webkit.WebView",
    ...
    ////////////////////////////////////////////////
    try {
      var apache_AbstractVerifier_1 = Java.use(
        "org.apache.http.conn.ssl.AbstractVerifier"
      );
      apache_AbstractVerifier_1.verify.overload(
        "java.lang.String",
        "java.security.cert.X509Certificate"
      ).implementation = function (a, b) {
        console.log(
          "[+] Bypassing Apache AbstractVerifier {1} check for: " + a
        );
        return;
      };
    } catch (err) {
    ...
    try {
      var apache_AbstractVerifier_2 = Java.use(
        "org.apache.http.conn.ssl.AbstractVerifier"
      );
      apache_AbstractVerifier_2.verify.overload(
        "java.lang.String",
        "javax.net.ssl.SSLSocket"
      ).implementation = function (a, b) {
        console.log(
          "[+] Bypassing Apache AbstractVerifier {2} check for: " + a
        );
        return;
      };
    } catch (err) {
    ...
    try {
      var apache_AbstractVerifier_3 = Java.use(
        "org.apache.http.conn.ssl.AbstractVerifier"
      );
      apache_AbstractVerifier_3.verify.overload(
        "java.lang.String",
        "javax.net.ssl.SSLSession"
      ).implementation = function (a, b) {
        console.log(
          "[+] Bypassing Apache AbstractVerifier {3} check for: " + a
        );
        return;
      };
    } catch (err) {
    ...
    try {
      var apache_AbstractVerifier_4 = Java.use(
        "org.apache.http.conn.ssl.AbstractVerifier"
      );
      apache_AbstractVerifier_4.verify.overload(
        "java.lang.String",
        "[Ljava.lang.String;",
        "[Ljava.lang.String;",
        "boolean"
        ...
        console.log(
          "[+] Bypassing Apache AbstractVerifier {4} check for: " + a
        );
        return;
      };
    } catch (err) {
    ...
    /////////////////////
    try {
      var CronetEngineBuilderImpl_Activity = Java.use(
      ...
      CronetEngine_Activity.enablePublicKeyPinningBypassForLocalTrustAnchors.overload(
        "boolean"
      ).implementation = function (a) {
        console.log(
          "[+] Disabling Public Key pinning for local trust anchors in Chromium Cronet"
        );
        var cronet_obj_1 =
          CronetEngine_Activity.enablePublicKeyPinningBypassForLocalTrustAnchors.call(
            this,
            true
          );
        return cronet_obj_1;
      ...
      CronetEngine_Activity.addPublicKeyPins.overload(
        "java.lang.String",
        "java.util.Set",
        "boolean",
        "java.util.Date"
        ...
        var cronet_obj_2 = CronetEngine_Activity.addPublicKeyPins.call(
          this,
          hostName,
          pinsSha256,
          includeSubdomains,
    ...
    try {
      ...
      var HttpCertificatePinning_Activity = Java.use(
        "diefferson.http_certificate_pinning.HttpCertificatePinning"
      );
      HttpCertificatePinning_Activity.checkConnexion.overload(
        "java.lang.String",
        "java.util.List",
        "java.util.Map",
        "int",
    ...
    try {
      ...
      var SslPinningPlugin_Activity = Java.use(
        "com.macif.plugin.sslpinningplugin.SslPinningPlugin"
      );
      SslPinningPlugin_Activity.checkConnexion.overload(
        "java.lang.String",
        "java.util.List",
        "java.util.Map",
        "int",
    ...
    ///////////////////////////////////////////////////////////////////////////////
    try {
      var UnverifiedCertError = Java.use(
      ...
      UnverifiedCertError.$init.implementation = function (reason) {
        try {
          var stackTrace = Java.use("java.lang.Thread")
            .currentThread()
            .getStackTrace();
          var exceptionStackIndex = stackTrace.findIndex(
            (stack) =>
              stack.getClassName() ===
              "javax.net.ssl.SSLPeerUnverifiedException"
          );
          ...
          console.log(
            '\x1b[36m[!] Unexpected SSLPeerUnverifiedException occurred related to the method "' +
              className +
              "." +
              methodName +
              '"\x1b[0m'
          ...
          if (
            ...
            console.log(
              '\x1b[34m[!] Starting to dynamically circumvent the SSLPeerUnverifiedException for the method "' +
                className +
                "." +
                methodName +
                '"...\x1b[0m'
              ...
              callingMethod.implementation = function () {
                console.log(
                  '\x1b[34m[+] Bypassing the unusual/obfuscated pinner "' +
                    ...
                    "." +
                    methodName +
                    '" via Frida function implementation\x1b[0m'
                );
          ...
          if (String(err2).includes(".overload")) {
            ...
            if (String(err2).includes("SSLPeerUnverifiedException")) {
              console.log(
                "\x1b[36m[-] Failed to dynamically circumvent SSLPeerUnverifiedException -> " +
                  err2 +
                  "\x1b[0m"
              );
            } else {
